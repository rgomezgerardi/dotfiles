...
# Backend to use to display websites. qutebrowser supports two different (webengine: Use QtWebEngine - recommended)
c.backend = 'webengine'

# This setting can be used to map keys to other keys. When a key is bound (via `bindings.default` or `bindings.commands`), the mapping is ignored.
...
## Text color of the completion widget. May be a single color to use for all columns or a list of three colors, one for each column (Type: QtColor)
...
# Background color of disabled items in the context menu. If set to null, the Qt default is used (Type: QssColor)
c.colors.contextmenu.disabled.bg = None

# Foreground color of disabled items in the context menu. If set to null, the Qt default is used (Type: QssColor)
c.colors.contextmenu.disabled.fg = None

# Background color of the context menu. If set to null, the Qt default is used (Type: QssColor)
c.colors.contextmenu.menu.bg = None

# Foreground color of the context menu. If set to null, the Qt default is used (Type: QssColor)
c.colors.contextmenu.menu.fg = None

# Background color of the context menu's selected item. If set to null, the Qt default is used (Type: QssColor)
c.colors.contextmenu.selected.bg = None

# Foreground color of the context menu's selected item. If set to null, the Qt default is used (Type: QssColor)
...
# Desaturation factor for images in dark mode. If set to 0, images are left as-is. If set to 1, images are completely grayscale
c.colors.webpage.darkmode.grayscale.images = 0.0

# Which images to apply dark mode to. With QtWebEngine 5.15.0, this setting can cause frequent renderer process crashes
...
# Threshold for inverting background elements with dark mode. Set to 256 to never invert the color or to 0 to always invert it. Note: This behavior is the opposite of `colors.webpage.darkmode.threshold.text`!
c.colors.webpage.darkmode.threshold.background = 0

# Threshold for inverting text with dark mode. Set to 256 to always invert text color or to 0 to never invert text color
...
# A list of patterns which should not be shown in the history. This only affects the completion. Changing this setting will cause the completion history to be regenerated on the next start, which will take a short while.
...
# Size (in bytes) of the HTTP network cache. Null to use the default value. With QtWebEngine, the maximum supported value is 2147483647 (~2GB).
...
# AppCache. If this setting is used with URL patterns, the pattern gets
...
# Default encoding to use for websites. The encoding must be a string describing an encoding such as _utf-8_, _iso-8859-1_, etc
...
# Default program used to open downloads. If null, the default internal handler is used. Any `{}` in the string will be expanded to the filename, else the filename will be appended (Type: String)
...
# Command (and arguments) to use for selecting multiple files in forms. The command should write the selected file paths to the specified file, separated by newlines. The following placeholders are defined: * `{}`: Filename of the file to be written to
c.fileselect.multiple_files.command = ['termite', '-e', 'vifm', '--choose-files={}']
#c.fileselect.multiple_files.command = ['xterm', '-e', 'ranger', '--choosefiles={}']

# Command (and arguments) to use for selecting a single file in forms. The command should write the selected file path to the specified file. The following placeholders are defined: * `{}`: Filename of the file to be written to
c.fileselect.single_file.command = ['termite', '-e', 'vifm', '--choose-files={}']
...
# Force a Qt platformtheme to use. This sets the `QT_QPA_PLATFORMTHEME` environment variable which controls dialogs like the filepicker. By default, Qt determines the platform theme based on the desktop environment (Type: String)
...
# Name of the session to save by default. If this is set to null, the session which was last loaded is saved (Type: SessionName)
...
#c.url.default_page = 'file:///home/dt.surf/html/index.html'
...
c.url.searchengines = {
        ...
        'au': 'https://aur.archlinux.org/packages/?O=0&SeB=nd&K={}',        
        're': 'https://reddit.com/r/{}',        
        'ub': 'https://urbandictionary.com/define.php?term={}',        
        'yt': 'https://youtube.com/results?search_query={}',
        'lt': 'https://1337x.to/search/{}/1/',
        'tc': 'https://www.tibia.com/community/?subtopic=characters&name={}',
        'tr': 'https://translate.google.com/?sl=en&tl=es&text={}&op=translate'
}
