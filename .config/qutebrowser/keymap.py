...
#config.bind(';t', 'hint --first inputs')
...
config.bind('<Ctrl-B>', 'run-with-count 2 scroll up')
#config.bind('<Ctrl-D>', 'scroll-page 0 0.5')
config.bind('<Ctrl-D>', 'run-with-count 2 scroll down')
...
config.bind('Sq', 'bookmark-list --tab')
config.bind('Ss', 'set')
...
config.bind('xa', 'hint links spawn termite -e "youtube-dl --extract-audio --audio-format mp3 --audio-quality 192k {hint-url}"')
config.bind('xb', 'config-cycle statusbar.show always never')
config.bind('xd', 'config-cycle content.user_stylesheets [] ["~/.config/qutebrowser/stylesheets/darculized/style.css"]')
#config.bind('xd', 'config-cycle --temp colors.webpage.darkmode.enabled true false ;; reload')
config.bind('xm', 'hint links spawn mpv {hint-url}')
config.bind('xo', 'set-cmd-text -s :open -b')
config.bind('xO', 'set-cmd-text :open -b -r {url:pretty}')
config.bind('xt', 'config-cycle tabs.show always never')
config.bind('xx', 'config-cycle statusbar.show always never ;; config-cycle tabs.show always never')
config.bind('xv', 'hint links spawn termite -e "youtube-dl {hint-url}"')
